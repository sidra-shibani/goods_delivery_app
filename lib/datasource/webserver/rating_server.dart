...
class RatingServer {
  ...
  Future<Response> getRatingSummery(int userId) {
    return dio.get('/ratings/users/$userId');
  }

  Future<Response> giveRating(int shipmentId, GiveRatingRequest model) {
    return dio.post('/ratings/shipments/$shipmentId', data: model.toJson());
  }
}
